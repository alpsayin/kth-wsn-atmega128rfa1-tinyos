...
extern int wait_flag; //TRUE whiles no signal received
extern char devicename[80];
extern long Baud_Rate; // default Baud Rate (110 through 38400)
extern long BAUD; // derived baud rate from command line
extern long DATABITS;
extern long STOPBITS;
extern long PARITYON;
extern long PARITY;
extern int Data_Bits; // Number of data bits
extern int Stop_Bits; // Number of stop bits
extern int Parity; // Parity as follows:
...
int someFunction(int Parm_Count, char *Parms[])
{
